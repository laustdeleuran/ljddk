...
define('framework/error',['jquery', 'framework/log'], function($, log) {
...
define('core',['jquery', 'framework/log', 'framework/error'], function($, log, error){
...
define('clndr',['moment', 'jquery', 'underscore'], function(moment, $, _) {
	/*
	 *               ~ CLNDR v1.2.0 ~
	 * ==============================================
...
define('project/calendar',['core', 'jquery', 'clndr'], function (core, $) {
